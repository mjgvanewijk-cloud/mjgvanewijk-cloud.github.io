// scripts/core/state/categories-store.js
import { loadCats, loadSettings, saveSettings } from "../storage/index.js";
...
export function syncSettingsCategoriesFromCats() {
  ...
  const cats = loadCats(); // Direct laden om recursie te voorkomen
